// Free Pass (bypass) button — shows remaining passes and handles monthly reset.
...
export function BypassButton() {
  const c = useColors();
  const { remaining, canUse, useBypass: activateBypass } = useBypass();
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        message={`You're about to use a Free Pass (${remaining} of 2 remaining this month). This temporarily disables app surveillance.`}
